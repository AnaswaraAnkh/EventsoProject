    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DEACTIVE', 'Inactive'), ('ACTIVE', 'Active')], max_length=20, null=True)),
                ('is_active', models.CharField(blank=True, default=True, max_length=20, null=True)),
                ('user_type', models.CharField(choices=[('USER', 'user'), ('Admin', 'admin'), ('EventTeam', 'eventteam'), ('Pending', 'pending'), ('CameraMan', 'cameraman'), ('Rejected', 'rejected'), ('MakeupArtist', 'makeupartist')], max_length=20, null=True)),
